    ...
    <form action="{{ route('persons.update', $person->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    <div class="card-header">Edit Person Details</div>
                    <div class="card-body">
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input class="form-control @error('first_name') is-invalid @enderror" id="inputFirstName"
                                    ...
                                    placeholder="Enter your first name" value="{{ old('first_name', $person->first_name) }}" required />
                                @error('first_name')
                            ...
                            <div class="col-md-4">
                                ...
                                @enderror"
                                    ...
                                    placeholder="Enter your middle name"  value="{{ old('middle_name',  $person->middle_name) }}" />
                                @error('middle_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror"
                                    ...
                                    placeholder="Enter your Contact Number" value="{{ old('contact_number',  $person->contact_number) }}" required />
            ...
            <div class="card col-xl-4">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2"
                        src="{{ $person->getFirstMediaUrl('cover') ?: asset('assets/img/demo/user-placeholder.svg') }}" id="preview_image" alt="Profile Picture" />
                    <!-- Profile picture help block-->
                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>

                    <input type="file" name="person_image" id="person_image" accept=".jpg, .jpeg, .png" class="d-none @error('person_image') is-invalid @enderror">
                    @error('person_image')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
